...
// Query: *[  _type == "customer"  && email == $email][0]{  _id,  email,  name,  clerkUserId,  razorpayCustomerId,  createdAt}
...
// Variable: CUSTOMER_BY_RAZORPAY_ID_QUERY
// Query: *[  _type == "customer"  && razorpayCustomerId == $razorpayCustomerId][0]{  _id,  email,  name,  clerkUserId,  razorpayCustomerId,  createdAt}
export type CUSTOMER_BY_RAZORPAY_ID_QUERYResult = {
  _id: string;
  email: string | null;
  name: string | null;
  clerkUserId: string | null;
...
// Query: *[  _type == "order"  && _id == $id][0] {  _id,  orderNumber,  clerkUserId,  email,  items[]{    _key,    quantity,    priceAtPurchase,    product->{      _id,      name,      "slug": slug.current,      "image": images[0]{        asset->{          _id,          url        }      }    }  },  total,  status,  address{    name,    line1,    line2,    city,    postcode,    country  },  razorpayOrderId,  createdAt}
...
// Query: *[  _type == "order"  && razorpayOrderId == $razorpayOrderId][0]{ _id }
export type ORDER_BY_RAZORPAY_ORDER_ID_QUERYResult = {
  _id: string;
} | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[\n  _type == \"customer\"\n  && razorpayCustomerId == $razorpayCustomerId\n][0]{\n  _id,\n  email,\n  name,\n  clerkUserId,\n  razorpayCustomerId,\n  createdAt\n}": CUSTOMER_BY_RAZORPAY_ID_QUERYResult;
    ...
    "*[\n  _type == \"order\"\n  && razorpayOrderId == $razorpayOrderId\n][0]{ _id }": ORDER_BY_RAZORPAY_ORDER_ID_QUERYResult;
